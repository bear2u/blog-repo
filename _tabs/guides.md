...
<h2 class="section-title">GitHub Trending (2026-03-15)</h2>
<div class="guide-grid">
  <div class="guide-card">
    <span class="badge badge-tool">Headless Browser</span>
    <h3><a href="/blog-repo/lightpanda-browser-guide/">Lightpanda Browser</a></h3>
    <p>Zig 기반 헤드리스 브라우저: 설치/아키텍처/CDP 자동화/운영까지 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-tool">Offline Server</span>
    <h3><a href="/blog-repo/project-nomad-guide/">Project N.O.M.A.D.</a></h3>
    <p>오프라인-우선 지식/교육 서버: 설치/아키텍처/API/운영·자동화까지 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-agent">Context DB</span>
    <h3><a href="/blog-repo/openviking-guide/">OpenViking</a></h3>
    <p>AI 에이전트용 Context Database: 설치/아키텍처/사용·API/운영까지 위키형 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-coding">Agent 0→1</span>
    <h3><a href="/blog-repo/learn-claude-code-guide/">Learn Claude Code</a></h3>
    <p>Claude Code-like 코딩 에이전트 최소 루프→팀/워크트리 격리까지 단계형 학습 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-coding">Claude Code</span>
    <h3><a href="/blog-repo/claude-code-best-practice-guide/">claude-code-best-practice</a></h3>
    <p>Commands/Agents/Skills/Hooks/MCP/Settings/Memory를 “베스트 프랙티스 + 구현 예시”로 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-coding">Methodology</span>
    <h3><a href="/blog-repo/superpowers-guide/">superpowers</a></h3>
    <p>에이전트형 스킬 프레임워크 & 개발 방법론: 설치/아키텍처/사용·모범사례 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-llm">AI 안전</span>
    <h3><a href="/blog-repo/heretic-guide/">Heretic (연구/보안 관점)</a></h3>
    <p>LLM 가드레일 약화/오남용 위험이 큰 도구를 “아키텍처/재현성/방어” 관점으로만 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-agent">Multi-Agent</span>
    <h3><a href="/blog-repo/mirofish-guide/">MiroFish</a></h3>
    <p>문서(시드)→시뮬레이션→리포트 파이프라인을 코드/설정 근거로 정리 (6챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-agent">Code Graph</span>
    <h3><a href="/blog-repo/gitnexus-guide/">GitNexus</a></h3>
    <p>지식 그래프 기반 코드 인덱싱: CLI+MCP/Web UI/운영 자동화 포인트 정리 (5챕터)</p>
  </div>
  <div class="guide-card">
    <span class="badge badge-agent">Agent Memory</span>
    <h3><a href="/blog-repo/cognee-guide/">Cognee</a></h3>
    <p>벡터+그래프 지식 엔진으로 에이전트 메모리 구축: 라이브러리/CLI/API/MCP 정리 (5챕터)</p>
  </div>
</div>
...
<div class="guide-grid">
  <div class="guide-card">
    <span class="badge badge-tool">플러그인/확장</span>
    <h3><a href="/blog-repo/claude-plugins-official-guide/">Claude Code Plugins Directory</a></h3>
    <p>Claude Code용 공식 플러그인 디렉터리: marketplace.json, 플러그인 구조, LSP/MCP 예제, 보안·검증 자동화까지 위키형 정리 (8챕터)</p>
  </div>
  <div class="guide-card">
  ...
  <div class="guide-card">
    ...
    <h3><a href="/blog-repo/claude-code-best-practice-guide/">claude-code-best-practice</a></h3>
    <p>Claude Code의 Commands/Agents/Skills/Hooks/MCP/Settings/Memory를 “베스트 프랙티스 + 구현 예시”로 정리한 지식베이스 (5챕터)</p>
  </div>
  <div class="guide-card">
