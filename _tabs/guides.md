...
<div class="guide-grid">
  <div class="guide-card">
    ...
    <p>1-bit LLM(BitNet b1.58)용 공식 추론 프레임워크: CPU/GPU 커널·실행 스크립트 중심으로 정리 (1챕터)</p>
  </div>
  <div class="guide-card">
...
<div class="guide-card">
  ...
  <p>문서 업로드→검색/대화까지 한 번에 제공하는 RAG 플랫폼: FastAPI/Next.js + Langflow/OpenSearch/Docling 기반 (1챕터)</p>
</div>
<div class="guide-card">
...
<div class="guide-card">
  ...
  <p>SOTA 오픈소스 TTS: 공식 문서(설치/추론/WebUI/서버/Docker) 링크와 레포 구조를 시작점으로 정리 (1챕터)</p>
</div>
<div class="guide-card">
