---
layout: post
title: "GitHub Trending Top 10 (Daily) - 2026-03-14"
date: 2026-03-14
permalink: /github-trending-top10-2026-03-14/
author: github
categories: [Trending]
tags: [Trending, GitHub]
original_url: "https://github.com/trending?since=daily"
excerpt: "2026-03-14 기준 GitHub Trending(daily) 상위 10개 저장소를 조사하고, 블로그 가이드 시리즈(기존/신규)를 연결합니다."
---

## 기준

- 대상: GitHub Trending (daily)
- 날짜: **2026-03-14**
- 원본: https://github.com/trending?since=daily
...
- OpenViking: `/blog-repo/openviking-guide/` (5챕터)
- dimos: `/blog-repo/dimos-guide/` (5챕터)
- Heretic: `/blog-repo/heretic-guide/` (5챕터, 연구/보안 관점으로만 정리)
