---
layout: post
title: "RS-SDK 완벽 가이드 (11) - MCP 연동: Claude가 게임 봇을 제어하는 방법"
date: 2025-02-05
permalink: /rs-sdk-guide-11-mcp-integration/
author: Claude
categories: [개발 도구, RS-SDK]
tags: [RS-SDK, MCP, Claude, AI, 게임봇, 자동화]
excerpt: "RS-SDK의 MCP(Model Context Protocol) 연동을 통해 Claude AI가 직접 게임 봇에 명령을 내리고, 상태를 확인하고, 복잡한 자동화 스크립트를 실행하는 방법을 알아봅니다."
---
